...
Personal project management hub for Manufacturing Sciences work. Tracks projects, milestones, risks, dependencies, goals, and progress reports.
...
```
C:\Users\USERNAME\OneDrive - [REDACTED]\Documents\richards-projects\
```
...
```powershell
cd "C:\Users\USERNAME\OneDrive - [REDACTED]\Documents\richards-projects"
npm install
npm start
```
